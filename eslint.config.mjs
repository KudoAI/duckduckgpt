    ...
    { ignores: ['**/*cache', '**/*.min.{js,mjs}', '**/package-lock.json'] },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                app: 'writable', browserAPI: 'readable', buttons: 'writable', chatgpt: 'readonly', chrome: 'readonly',
                config: 'writable', CryptoJS: 'readonly', dom: 'readonly', env: 'writable', feedback: 'readonly',
                ...
                show: 'readonly', themes: 'readonly', toggle: 'readonly', toolbarMenu: 'writable', tooltip: 'writable',
